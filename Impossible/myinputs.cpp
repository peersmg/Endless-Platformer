...
// Version 13.01	Use EXLUSIVE mouse and keyboard


// Version 13.0 Update char to wchar_t and string to wstring
...
#define ERRORSTRING(x) DXGetErrorString(x)
// *************************************************************************************
...
:mkiMaxJoystickAxis(100)
{
    ...
    // NO error reporting here. Probably does not have the specified axis
